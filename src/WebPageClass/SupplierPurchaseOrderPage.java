...
public class SupplierPurchaseOrderPage {
	BasePage page;

	WebDriver PageClassWebDriver;

	public SupplierPurchaseOrderPage(WebDriver TestClassParameterDriver) {
	...
	@FindBy(how = How.XPATH, using = "/html/body/div[1]/div/div[3]/div/div[2]/div[3]/div[1]/div[1]/div/a[2]")
	WebElement acceptrequestButton;

	@FindBy(how = How.XPATH, using = "/html/body/div[1]/div/div[3]/div/div[2]/div[3]/div[1]/div[1]/div/a[3]")
	...
	public String getAcceptButton() {
		page.waitForWebElementToAppear(acceptrequestButton);
		return acceptrequestButton.getText();
	}

	public String getAcceptButtonColor() {
		page.waitForWebElementToAppear(acceptrequestButton);
		return acceptrequestButton.getCssValue("background-color");
	}

	public String getRejectButton() {
		page.waitForWebElementToAppear(rejectrequestButton);
		return rejectrequestButton.getText();
	}

	public String getRejectButtonColor() {
		page.waitForWebElementToAppear(rejectrequestButton);
		return rejectrequestButton.getCssValue("background-color");
	}
